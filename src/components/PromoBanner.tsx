    ...
    <div className="relative h-80 rounded-[2rem] overflow-hidden mb-8 group">
      ...
      <div className="absolute inset-0 p-12 flex flex-col justify-center max-w-2xl">
        <div className="flex items-center gap-3 mb-6">
          <span className="px-3 py-1 bg-blue-600 text-white text-[10px] font-bold rounded-full uppercase tracking-[0.2em]">Featured Event</span>
        ...
        <h1 className="text-5xl font-black text-white mb-4 leading-tight tracking-tight">
          Champions League <br/> <span className="text-blue-500">Final Showdown</span>
        </h1>
        
        <p className="text-gray-300 text-lg mb-8 max-w-md">
          Experience the thrill of Europe's elite football competition in stunning 4K resolution.
        </p>
        ...
        <div className="flex items-center gap-4">
          ...
          <button className="px-8 py-4 bg-white/10 hover:bg-white/20 text-white rounded-2xl font-bold transition-all backdrop-blur-md">
            View Stats
          </button>
        </div>
      </div>
